...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">教师教学档案管理</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li date-refresh="1">
                        <a _href="${pageContext.request.contextPath}/user/findAll?page=1&size=5">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>教师信息管理</cite>
                    ...
                    <li date-refresh="1">
                        <a _href="${pageContext.request.contextPath}/textbook/findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>教材设计管理</cite>
                    ...
                    <li date-refresh="1">
                        <a _href="${pageContext.request.contextPath}/classroomTeaching/findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>课堂教学管理</cite>
                    ...
                    <li date-refresh="1">
                        <a _href="${pageContext.request.contextPath}/evaluation/findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学科评估管理</cite>
                    ...
                    <li date-refresh="1">
                        <a _href="${pageContext.request.contextPath}/thesis/findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>毕业论文管理</cite>
