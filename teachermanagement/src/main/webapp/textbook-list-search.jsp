        ...
        <c:forEach items="${textbookList}" var="textbook">
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','${pageContext.request.contextPath}/textbook/echo?id='+${textbook.id},400,500)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(){
              ...
              location.href = "${pageContext.request.contextPath}/textbook/delete?id="+id;
